...
load_models <- function() {
  list(
    models_combined = read_rds(Sys.getenv("CBC_MODEL_PATH", "models/cbc_models_combined.RDS")),
    mix_ratio_workflows = read_rds(Sys.getenv("CBC_MIX_MODEL_PATH", "models/cbc_mix_ratio_model.RDS"))
  )
}
